...
description: "A short note about moving the OpenScan blog to its new home powered by Jekyll."
math: true
categories:
  - "News"
tags:
...
We moved the OpenScan blog to a new home: [blog.openscan.eu](https://blog.openscan.eu/) and changed it from a Shopify blog to a Jekyll-based static site.
...
We [promised](https://blog.openscan.eu/posts/new-years-recap-and-outlook/) at the beginning of this year that we wanted to be more communcative about OpenScan and its future. The new blog is a step in that direction.
...
This new version is built with [Jekyll](https://jekyllrb.com/) and the [Chirpy theme](https://github.com/cotes2020/jekyll-theme-chirpy). 
